			...
			if(tempLoanType.equals("Personal"))
				{
					...
					System.out.println(" Customer "+(i+1)+" :-\t"+customerList[i].displayCustomerDetails()+personalLoanList[i].displayLoanDetails());
				}
			...
			else if(tempLoanType.equals("Jewel"))
				{
					...
					if(i==0)
						System.out.println(" Customer Name \t Loan Type \t Interest Rate \t Loan Amount \t Total Amount\n");
					System.out.println(" Customer "+(i+1)+" :-\t"+customerList[i].displayCustomerDetails()+jewelLoanList[i].displayLoanDetails());
				}
